...
csq_name="qexample2"
csq_explanation = "True. Each node's right and left subtrees have a height difference of at most one. The nodes with keys 4 and 12 (leaves) have height 0, the node with key 17 has height 1 (for the edge between 17 and 12) and the node with key 10 has height 2 (the longest path down is 10 to 17 to 2, using two edges)."
</question>
...
csq_options =  ["True", "False"]
csq_name="qexample4"
csq_explanation = "True. From the root (has key 20), the left subtree (node with key 13) has height zero (it's a leaf), and there is no right subtree."
</question>
...
csq_options =  ["True", "False"]
csq_name="qexample5"
csq_explanation = "False. The node with key 18 has height 1, and there is no right child of the root. The root has a skew equal to $(-1) - (1) = -2$ The skew of an AVL tree must be $\in {-1, 0, 1}$."
</question>
