...
cs_long_name = cs_content_header = "Testing s092"
cs_title = 'Testing s092'  # the browser's title bar
...
if 's092.xvm.mit.edu' in cs_url_root:
    ...
    # local; use 'dummy'
    cs_auth_type='dummy'  # use the default (username/password based) authentication method
...
if 's092.xvm.mit.edu' in cs_url_root:
    csq_python_interpreter = '/home/ta/python36_sandbox/bin/python3'
    csq_bwrap_extra_ro_binds = [
        ('/home/ta/python36_sandbox', '/home/ta/python36_sandbox'),
